...
BUSCO_DB="/Volumes/oli/databases/busco_database/busco_downloads"
BUSCO_PLOT="~/miniconda3/envs/busco/bin/generate_plot.py"
MAKE_BUSCO_SUMMARIES="/Volumes/oli/RESULTS/scripts/01_assembly/03_busco/make_BUSCO_summaries.py" # Script that creates folder with all BUSCO summaries and gives them better namings

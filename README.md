...
The data available at the start of the project were paired read libraries (bulk RNA-seq data) after basic quality check and trimming for 5 consecutive stages of the *O. limacina* life cycle: 
...
For *de novo* transcriptome assembly were used 2 different assemblers, [rnaSPAdes](https://gensoft.pasteur.fr/docs/SPAdes/3.14.0/rnaspades_manual.html) (v.3.15.5) and [Trinity](https://github.com/trinityrnaseq/)(v.2.15.1). **Both decontamination and assembly were performed using public [Galaxy](https://github.com/galaxyproject) servers**.
...
Protein-coding contigs in best assembly were identified with [Transdecoder](https://github.com/TransDecoder/) (v.5.7.1). Expression levels for transcripts were quantified with [Salmon](https://github.com/COMBINE-lab/salmon) (v.1.10.2). For subsequent analysis we used only contigs contigs with with protein length >= 100 aminoacids and expression level at least 1 TPM in any sample. Annotation was performed with [eggNOG-mapper](http://eggnog-mapper.embl.de/) (v.2) online tool. **67963** (12.8% of all transcripts) coding sequences with a significant expression level were found in this assembly and **28551** (42% of coding transcript) of them were annotated. 
